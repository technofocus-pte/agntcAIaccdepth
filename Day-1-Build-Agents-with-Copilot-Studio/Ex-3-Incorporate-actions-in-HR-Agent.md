...
11. 在 **提问** 节点下，点击 **添加节点** **(1)**，然后选择 **使用自适应卡片提问** **(2)**。
...
14. 在 **使用自适应卡片提问** 节点下，点击 **添加节点** **(1)**，然后选择 **添加操作** **(2)**，然后选择 **新建 PowerAutomate 流** **(3)**。这将重定向到 **Power Platform 环境**。
