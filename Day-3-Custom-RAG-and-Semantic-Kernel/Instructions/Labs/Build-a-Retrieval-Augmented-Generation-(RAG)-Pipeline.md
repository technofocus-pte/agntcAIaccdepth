...
8. **assets (1)** フォルダーを展開し、**products.csvファイル(2)** を選択します。このファイルには、チャットアプリで使用されるすべてのデータセットの例が含まれています。

    ![](../media/af35.png)

9. **create_search_index.py**を選択します。このファイルは、埋め込みモデルからベクトル化されたデータを保存します。.  
...
11. コンソールからAzureアカウントにログインし、アカウント認証の指示に従います：
...
12. Visual Studio Codeウィンドウを最小化します。

    - **職場または学校のアカウント (1)** を選択し、**続行 (2)** をクリックします。

      ![](../media/af37.png)    

    - **パスワード TAP** を入力し、**サインイン (2)** をクリックします。

    - **いいえ、このアプリにのみサインインします。** をクリックします。

      ![](../media/rg10.png)      

13. Visual Studio Codeターミナルに戻り、デフォルトのサブスクリプションを受け入れるために**Enter**を押します。
