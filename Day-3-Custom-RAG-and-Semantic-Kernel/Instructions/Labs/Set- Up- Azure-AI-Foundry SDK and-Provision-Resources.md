...
10. Azure AI Foundry タブに戻り、[Management Center] を選択します。
    
11. プロジェクトで「接続されたリソース」を選択します。次に「+新しい接続」を選択します。Azure AI Searchを選択し、「接続の追加」を選択してから「閉じる」を選択します。

13. 次に、Foundry ハブの下にある「接続済みリソース」を選択します。次に「+新しい接続」を選択します。「Azure AI Search」を選択し、「接続を追加」を選択してから「閉じる」を選択します。
...
5. **Azure portal** に移動します。**AI Search (1)** を検索し、サービスから **AI Search (2)** リソースを選択します。

   ![](./media/ag20.png)

6. するとAIファウンドリーに移動します。**AI Search** (1)内で**Create** (2)をクリックします。
   ![](./media/day2ex3-001.png)

7. **検索サービスの作成** ペインで次の詳細を入力し、**確認と作成** をクリックします (4)
...
8. **確認 + 作成** で、**作成** をクリックします。

   ![](./media/day2ex3-003.png)

9. デプロイが完了するまで待ってから、[**リソースに移動**] をクリックします。

   ![](./media/day2ex3-004.png)
   
### タスク3：プロジェクトの要件をインストールする
