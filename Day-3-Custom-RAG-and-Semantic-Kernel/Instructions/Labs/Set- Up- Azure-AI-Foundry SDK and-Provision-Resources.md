...
17. **検索サービスの作成** ペインで次の詳細を入力し、**確認と作成** をクリックします (4)
...
21. プロジェクトで「接続されたリソース」を選択します。次に「+新しい接続」を選択します。Azure AI Searchを選択し、「接続の追加」を選択してから「閉じる」を選択します。

22. 次に、Foundry ハブの下にある「接続済みリソース」を選択します。次に「+新しい接続」を選択します。「Azure AI Search」を選択し、「接続を追加」を選択してから「閉じる」を選択します。
